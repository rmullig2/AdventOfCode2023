...
def get_next_value(num_list):
    ...
    while not all([ value == 0 for value in current_list ]):
        ...
        current_list = list_of_lists[-1]
    return get_last_value(list_of_lists)
...
if __name__ == '__main__':
    if len(sys.argv) < 2:
        print("Usage: day9_part1.py input_filename")
        exit(1)
